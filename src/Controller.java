...
public class Controller {
    ...
    private static void wirteToCSV() throws Exception {
        ...
        bw.write("Downloaded URL, Size in Bytes, # of outlinks, ContentType\n");
    ...
    private static List<Object> performCrawling() throws Exception {
        ...
        String crawlStorageFolder = "Users/dongwanxu/Desktop/cs572/hw2/data/crawl";
...
//        bw.write("410 Gone: " + statusCodes.get(410) + "\n\n");
        ...
        for (String type : contentTypes.keySet()) {
            ...
            System.out.println(contentTypes.keySet().size());
